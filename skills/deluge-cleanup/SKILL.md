...
- Plex: `http://10.0.0.100:32400` / token `C6DFr9z3gxx7CvyxsByc`
- Sonarr: `http://10.0.0.100:8989/sonarr` / API key `a04acb1fcde0450091e1f23c7a269c9b`
- Radarr: `http://10.0.0.100:7878/radarr` / API key `861dc41877ff4bb7ae17c113fc89c361`
