...
DELUGE_PASSWORD = os.environ.get("DELUGE_PASS",  "kBrsL9ARrPJ7F%")
PLEX_URL        = os.environ.get("PLEX_URL",     "http://10.0.0.100:32400")
PLEX_TOKEN      = os.environ.get("PLEX_TOKEN",   "C6DFr9z3gxx7CvyxsByc")
SONARR_URL      = os.environ.get("SONARR_URL",   "http://10.0.0.100:8989/sonarr")
SONARR_KEY      = os.environ.get("SONARR_KEY",   "a04acb1fcde0450091e1f23c7a269c9b")
RADARR_URL      = os.environ.get("RADARR_URL",   "http://10.0.0.100:7878/radarr")
RADARR_KEY      = os.environ.get("RADARR_KEY",   "861dc41877ff4bb7ae17c113fc89c361")
